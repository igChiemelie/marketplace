...
{
    protected $fillable = ['order_number', 'customer_id', 'total_amount', 'fullname', 'email', 'phone', 'address', 'city', 'zip', 'status', 'payment_status', 'payment_method', 'shipping_address', 'billing_address', 'notes'];
