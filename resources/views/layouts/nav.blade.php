...
<head>
    ...
    <title>MarketHub - Multi-Vendor E-Commerce</title>
    ...
    <header>
        <div class="container">
            <div class="header-top">
                <a href="#" class="logo" id="home-link"><i class="fas fa-store"></i>Market<span>Hub</span></a>
        ...
        <li><a href="{{ url('/beauty') }}">Beauty</a></li>
